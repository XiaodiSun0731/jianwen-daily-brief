...
- Visual freshness rule: Today and article detail use the feed's `heroImage`, selected from `public/images/daily-hero-01.png` through `daily-hero-03.png` by the daily collector. Do not restore the fixed editorial hero. `public/images/app-icon.png` is the app identity asset used by favicon, Apple touch icon, manifest, and push notifications.

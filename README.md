...
- 实时资讯：`.github/workflows/daily-feed.yml` 定时抓取 RSS/Atom，并在 `src/data/daily-feed.json` 保存原文链接和发布时间；`.github/workflows/weekly-review-reminder.yml` 独立负责周六 15:00 提醒。
